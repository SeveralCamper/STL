...
int main()
{
	...
	// Метод push_front() для вектора не раелизован из-за невыгодной асимтотической сложности данного действия O(n). Так нам намекают, что лучше все добавлять в конец
