...
// Алгоритмы STL библиотеки работают с любыми контейнерами через итераторы. Важно отметить, что именно итераторы дают гибкую возможность
// Работы контейнеров и алгоритмов. Они служат неким связующим звеном.
